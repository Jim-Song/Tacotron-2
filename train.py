...
def prepare_run(args):
	...
	infolog.init(os.path.join(log_dir, 'Terminal_train_log.log'), run_name, args.slack_url)
...
def main():
	...
	parser.add_argument('--tacotron_input', default='', help='the name of the corpus, comma-separated, also could be "english_all"')
	...
	parser.add_argument('--wavenet_train_steps', type=int, default=1900000, help='total number of wavenet training steps')
